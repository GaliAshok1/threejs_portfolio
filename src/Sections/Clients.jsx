...
const Clients = () => {
    return (
        <section className="c-space my-20">
            <h3 className="head-text">Testimonials & Reviews</h3>

            <div className="client-container ">
                {clientReviews.map((item) => (
                    <div key={`review-${item.id}`} className="client-review transition-all duration-300 hober:bg-cyan hover:bg-opacity-10 hover:shadow-lg p-5 rounded-lg">
                        <div>
